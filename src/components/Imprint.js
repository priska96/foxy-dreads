...
function Imprint() {
    return (
        <div className="Imprint my-5">
            <Jumbotron className="light-yellow-bg text-white text-left">
                <Row>
                    <Col sm={6}>
                        <h2>Impressum</h2>
                        <p>
                            <span className="underline">Angaben gem. § 5 TMG:</span><br/><br/>
                            Jiska Kohnen<br/>
                            Bitburger Straße 109a<br/>
                            13051 Berlin<br/><br/>
                            <span className="underline">Kontaktaufnahme:</span><br/>
                            Telefon:<br/>
                            E-Mail:  <a href="mailto:jiskakkohnen@gmail.com">jiskakkohnen@gmail.com</a><br/><br/>
                            <b>Haftungsausschluss – Disclaimer:</b><br/>
                            <span className="underline">Haftung für Inhalte</span><br/><br/>
                            ...
                            wir diese Inhalte unverzüglich entfernen.<br/><br/>

                            <span className="underline">Haftungsbeschränkung für externe Links</span><br/><br/>
                            ...
                            rechtswidriger Inhalte zu verhindern.<br/><br/>
                            ...
                            Diskussionsforums. Für illegale, fehlerhafte oder unvollständige Inhalte und insbesondere
                            für Schäden, die aus der Nutzung oder Nichtnutzung solcherart dargestellten Informationen
                            ...
                            Urheberrecht (<a href="http://www.gesetze-im-internet.de/bundesrecht/urhg/gesamt.pdf" target="_blank">http://www.gesetze-im-internet.de/bundesrecht/urhg/gesamt.pdf</a>). Die
                            ...
                            i.S.d. Urhebergesetzes (<a href="http://www.gesetze-im-internet.de/bundesrecht/urhg/gesamt.pdf" target="_blank">http://www.gesetze-im-internet.de/bundesrecht/urhg/gesamt.pdf</a>).
                            ...
                            Inhalte unverzüglich entfernen.<br/><br/>

                            Dieses Impressum wurde freundlicherweise von <a href={"https://wwww.jurarat.de"}>jurarat.de</a> zur Verfügung gestellt.
